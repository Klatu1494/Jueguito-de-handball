	...
	moverHacia(x, y, jugadoresEmpujados) {
		...
		for (var equipo of equipos)
			for (var jugador of equipo.jugadores)
				if (dist(nuevoCentro.x, nuevoCentro.y, jugador.centro.x, jugador.centro.y) < this.size / 2 + jugador.size / 2 - 1 / 255) this.empujarDesde(nuevoCentro.x, nuevoCentro.y, jugador, jugadoresEmpujados + 1 || 1);
		for (var equipo of equipos)
			for (var jugador of equipo.jugadores)
				if (this !== jugador) {
