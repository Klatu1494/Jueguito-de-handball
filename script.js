...
function nuevoPartido(humanos){
	...
	console.log(equipo0Seleccion.arquero.stats)
...
function gol(equipoQueHizoGol){
	...
	equipo0.arquero.centro=new Centro(cancha.x, cancha.y+cancha.height/2);
	equipo1.arquero.centro=new Centro(cancha.x+cancha.width, cancha.y+cancha.height/2);
